...
/** \mainpage RoboComp::cameraVREPcpp
 *
 * \section intro_sec Introduction
 *
 * The cameraVREPcpp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/cameraVREPcpp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class cameraVREPcpp : public RoboComp::Application
{
public:
	cameraVREPcpp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::cameraVREPcpp::run(int argc, char* argv[])
{
