 ...
 *
 * The differentialrobotVREP component...
 *
...
class differentialrobotVREP : public RoboComp::Application
{
public:
	differentialrobotVREP (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::differentialrobotVREP::initialize()
{
...
int ::differentialrobotVREP::run(int argc, char* argv[])
{
...
int main(int argc, char* argv[])
{
	...
	::differentialrobotVREP app(prefix);
